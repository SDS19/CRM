...
<head>
	...
	<script type="text/javascript">
		$(function () {
			$(".time_expectedDate").datetimepicker({
				minView: "month",
				language:  'zh-CN',
				format: 'yyyy-mm-dd',
				autoclose: true,
			...
			$(".time_nextContactTime").datetimepicker({
				minView: "month",
				language:  'zh-CN',
				format: 'yyyy-mm-dd',
				autoclose: true,
			...
			$("#create-stage").change(function () {
				...
				$.ajax({
					url: "transaction/getPossibility",
					type: "get",
					dataType: "json",
					success: function (data) {
						$("#create-possibility").val(data[stage]);
					}
				})
			})
...
<body>
	...
	<form id="tranForm" action="transaction/save" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time_expectedDate" id="create-expectedClosingDate" name="expectedDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-customerName" name="customerName" placeholder="support auto complete...">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time_nextContactTime" id="create-nextContactTime" name="nextContactTime">
			</div>
		</div>
